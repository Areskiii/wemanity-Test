						...
						<thead>
							<tr>
								...
								<th class="text-left"><?php if ($sort == 'title') { ?>
									...
									<?php } ?></th>
								<th class="text-left"><?php if ($sort == 'text') { ?>
						...
						<tbody>		
							...
							<tr>
								<td class="text-center"><?php if (in_array($Article['id'], $selected)) { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $Article['id']; ?>" checked="checked" />
									<?php } else { ?>
									<input type="checkbox" name="selected[]" value="<?php echo $Article['id']; ?>" />
									<?php } ?>
								</td>
								<td class="text-left"><?php echo $Article['id']; ?></td>
								<td class="text-left"><?php echo $Article['title']; ?></td>
								<td class="text-left"><?php echo $Article['text']; ?></td>
								<td class="text-left"><?php echo $Article['Etat']; ?></td>
								<td class="text-right">
									<a href="<?php echo $Article['edit']; ?>" rel="tooltip" title="" class="btn btn-success btn-simple btn-xs" data-original-title="<?php echo $button_edit; ?>">
